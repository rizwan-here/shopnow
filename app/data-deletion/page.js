    ...
    <main className="legal-shell">
      <div className="container">
        <article className="soft-card legal-card">
          ...
          <p>
            <strong>Effective Date:</strong> 15/04/26
            <br />
            <strong>Last Updated:</strong> 27/04/26
          </p>
          ...
          <ul>
            ...
            <li>uploaded product data</li>
            <li>store images and branding assets</li>
            <li>connected login identity references</li>
            <li>customer-facing storefront data</li>
            <li>contact details stored in your seller account</li>
          </ul>

          <p>
            If applicable, order-related records that are not legally required to be retained may
            also be deleted.
          </p>
          ...
          <ul>
            ...
            <li>security and backup restoration processes</li>
          </ul>

          <p>
            If any information must be retained for these reasons, it will be kept only as long as
            reasonably necessary.
          </p>

          <h2>5. Processing time</h2>
          <p>
            We will review and process valid deletion requests within a reasonable time after
            identity verification.
          </p>
          <p>
            If additional information is needed to verify the request, we may contact you by email.
          </p>

          <h2>6. Questions</h2>
          <p>
            If you have any questions about account deletion or data handling, contact:
          </p>
